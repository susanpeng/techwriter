...
<xsl:output name="front-format" method="xhtml" indent="yes"
 ...
 <xsl:output name="glossary-format" method="xhtml" indent="yes"
    ...
    doctype-public="-//W3C//DTD XHTML 1.0 Transitional//EN" />
            ...
            -->
	<xsl:output name="frame-format" method="xhtml" indent="no"
 ...
 <!-- Create the TOC page. -->
  ...
  <!-- Create the home page. -->
   <xsl:result-document href="../Output/helpmanual/index.html" format="frame-format">
  <xsl:call-template name="frameset"/>
  </xsl:result-document>
  
     <xsl:result-document href="../Output/helpmanual/front.html" format="front-format">
...
<!-- Create an HTML page for each topic element. Use the newtopicpage variable to name each HTML topic page. -->
 ...
 <html xmlns="http://www.w3.org/1999/xhtml">
      ...
      <link rel="stylesheet"  type="text/css" href="stylesheets/styles-frame.css"/>
...
<div class="topiccontent"><xsl:apply-templates select="body"/> 
...
<xsl:variable name="nexttopicnumber" select="concat('topic',position()+1,'.html')"/>
   ...
   <div class="subheader"><span class="breadcrumbs"><a href="front.html">Home</a></span>
...
<xsl:variable name="nexttopicnumber" select="concat('topic',position()+1,'.html')"/>
<div class="navarrows">
    <xsl:if test="position()=1"><a href="front.html"><img src="stylesheets/2.png" alt="Go to previous page"/></a></xsl:if>
   <xsl:text> </xsl:text>
...
<xsl:template name="toc">
 ...
 <meta http-equiv="content-type" content="text/html; charset=utf-8" />      
      ...
      <body>
      <div class="tocheader">
      <h1 class="toctitle"><xsl:value-of select="helpmanual/front/title"/></h1>
      </div>
           <div class="main">
            <!-- Output a link for each topic. -->
        <div class="tocpage">
        <a href="front.html" alt="frontpage" target="contentwin">Home</a><br />
			...
			<a><xsl:attribute name="href">topic<xsl:value-of select="position()"/>.html</xsl:attribute>
			<xsl:attribute name="target">contentwin</xsl:attribute>
			<xsl:value-of select="./title"/></a>
			<br />
</xsl:for-each>
<xsl:if test="//biblio"><a href="biblio.html" alt="bibliography" target="contentwin">Bibliography</a>  <br />
</xsl:if>

<xsl:if test="//glossary"><a href="glossary.html" alt="glossary" target="contentwin">Glossary</a><br />
</xsl:if> 
<xsl:if test="//mcomment"><a href="mcomment.html" alt="markers-comments" target="contentwin">Marker's comments</a><br />
</xsl:if>
<xsl:if test="//indexterm"><a href="indexpage.html" alt="Index" target="contentwin">Index</a>
<br />
</xsl:if>
</div>
</div>
 ...
 <xsl:template name="toc-indent">
   <xsl:for-each select="ancestor::topic">&#160;&#160;&#160;</xsl:for-each>
 </xsl:template>
...
<xsl:template name="glossary">
 <html xmlns="http://www.w3.org/1999/xhtml">
      <head><title><xsl:value-of select="helpmanual/front/title"/> </title>
      <link rel="stylesheet"  type="text/css" href="stylesheets/styles-frame.css"/></head>
      <body>
...
<!-- template for framset index page -->
...
<xsl:template name="frameset">
 <html xmlns="http://www.w3.org/1999/xhtml">
     ...
     <frame name="contentwin" id="contentwin" src="front.html" />
     </frameset>
    </html>
</xsl:template>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
 <link rel="stylesheet" href="stylesheets/styles-frame.css" type="text/css"></link>
     </head>
     <body>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
 <link rel="stylesheet" href="stylesheets/styles-frame.css" type="text/css"></link>
   ...
   <div class="topiccontent">
    ...
    <div class="mcommenttitle"><a><xsl:attribute name="href">front.html</xsl:attribute><xsl:value-of select="ancestor::front/title"/></a> </div>
...
<xsl:apply-templates/></div>  
    ...
    <xsl:for-each-group select="//mcomment"  group-by="ancestor::topic[1]"> 
     <div class="mcommenttitle"><a><xsl:attribute name="href">topic<xsl:value-of select="count(ancestor-or-self::topic[1] | preceding::topic | ancestor-or-self::topic) "/>.html</xsl:attribute><xsl:value-of select="ancestor::topic[1]/title"/></a> </div>
     <xsl:for-each select="current-group()" > 
<div class="markerscomment"><xsl:attribute name="id">comment<xsl:number  count="mcomment" from="helpmanual" level="any"/></xsl:attribute>
...
<img alt="Link to Comment" src="stylesheets/lightbulby.jpg"/></a>
</xsl:template>
